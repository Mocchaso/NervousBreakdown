...
DWORD WINAPI windowMain(LPVOID arg) {
	...
	int sw = width + (rc1.right - rc1.left) - (rc2.right - rc2.left);
	int sh = height + (rc1.bottom - rc1.top) - (rc2.bottom - rc2.top);
	SetWindowPos(hWnd, NULL, 0, 0, sw, sh, (SWP_NOZORDER | SWP_NOOWNERZORDER | SWP_NOMOVE));
